...
var ASM_CONSTS = {
  8766040: () => { if (0 && ENVIRONMENT_IS_NODE) { FS.mkdir('/hostcwd'); FS.mount(NODEFS, { root: '.' }, '/hostcwd'); FS.mkdir('/hostfs'); FS.mount(NODEFS, { root: '/' }, '/hostfs'); } }
};
...
var _errmsg = Module['_errmsg'] = createExportWrapper('errmsg');
var _prompt = Module['_prompt'] = createExportWrapper('prompt');
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 8713896;
